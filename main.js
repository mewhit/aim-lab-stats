...
var $author$project$Main$initModel = {data: $elm$core$Maybe$Nothing, name: ''};
			...
			_Utils_update(
				model,
				{
					data: $elm$core$Maybe$Just(
						A2($elm$json$Json$Decode$decodeString, $elm$json$Json$Decode$string, data))
				}),
			$elm$core$Platform$Cmd$none);
	});
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"Convert":["String.String"]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});
